...
process = Popen(['df', '-B', str(block_size), args.directory], stdout=PIPE)
df_output = process.communicate()[0]
...
process = Popen(['du', '-B', str(block_size), args.directory], stdout=PIPE)
du_output = process.communicate()[0]
